            ...
            <div className='container sec2_cont mt-5'>
                ...
                <Slider {...settings}>
                    <div className='container'>
                        <div className='row'>
                            <div className='col-lg-6 text-center pl-4'>
                                <img className='s2_img img-fluid' src='https://resources.turo.com/f/81934/416x284/6e085cbe0e/image_outdoors_416x285.jpg'></img>
                            </div>
                            <div className='col-lg-6 s2_detail'>
                    ...
                    <div>
                        <div className='row'>
                            <div className='col-lg-6 text-center ml-4'>
